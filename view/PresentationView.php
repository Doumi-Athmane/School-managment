...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./public/css/presentation.css"  type="text/css" />
    ...
    <br>
    <br>
    <center><h2>Présentation de l'école</h2></center>
    <section class="content">
        
            <?php $i=0; 
            foreach($presentations as $presentation):
             if($i%2===0){?>
                <div class="card mb-3" style="max-width: 98%;    position: static ;">
                    <div class="row g-0">
                        <div class="col-md-4">
                        <img src="<?=$presentation["Image"]?>" alt="<?= $presentation["IdPresentation"]?>" width="100%" height="70%">
                        </div>
                        <div class="col-md-8">
                        <div class="card-body">
                            <br>
                            <p class="card-text"><?= $presentation["Paragraph"]?></p>
                        </div>
                        </div>
                    </div>
                </div> 
